...
function commentFooter() {
    ...
    return `This comment was automatically generated by [workflow](${actionUrl}) using [github-action-benchmark](https://github.com/marketplace/actions/continuous-benchmark-with-pr-comments).`;
}
...
async function leaveComment(commitId, body, token, config) {
    ...
    if (config.prCommentAlways) {
        ...
        const pr = ((_b = github.context.issue) === null || _b === void 0 ? void 0 : _b.number) || ((_c = issues.data[0]) === null || _c === void 0 ? void 0 : _c.number);
        if (pr) {
